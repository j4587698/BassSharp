...
public static partial class Bass
{
    ...
    internal static partial IntPtr BASS_PluginGetInfo(int handle);
    ...
    internal static partial int BASS_PluginLoad(string fileName, BassFlags flags = BassFlags.Unicode);
    ...
    /// </remarks>
    /// <exception cref="Errors.Handle"><paramref name="handle" /> is not valid.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_PluginFree")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool PluginFree(int handle);
}