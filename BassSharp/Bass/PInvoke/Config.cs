...
public static partial class Bass
{
    ...
    [LibraryImport(DllName, EntryPoint = "BASS_SetConfig")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool Configure(Configuration option, [MarshalAs(UnmanagedType.Bool)]bool newValue);
    ...
    [LibraryImport(DllName, EntryPoint = "BASS_SetConfig")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool Configure(Configuration option, int newValue);
    ...
    /// <param name="newValue">The New Value of the option.</param>
    /// <returns>If succesful, then <see langword="true" /> is returned, else <see langword="false" /> is returned. Use <see cref="LastError" /> to get the error code.</returns>
    [LibraryImport(DllName, EntryPoint = "BASS_SetConfigPtr")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool Configure(Configuration option, IntPtr newValue);
    ...
    [LibraryImport(DllName, EntryPoint = "BASS_GetConfig")]
    public static partial int GetConfig(Configuration option);
    ...
    [LibraryImport(DllName, EntryPoint = "BASS_GetConfigPtr")]
    public static partial IntPtr GetConfigPtr(Configuration option);
    ...
    /// When asynchronous file reading is enabled, the Buffer level is available from <see cref="BassSharp.Bass.PInvoke.Bass.StreamGetFilePosition"/>.
    /// </remarks>
