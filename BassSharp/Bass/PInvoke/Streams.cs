...
public static partial class Bass
{
    ...
    [LibraryImport(DllName, EntryPoint = "BASS_StreamGetFilePosition")]
    public static partial long StreamGetFilePosition(int handle, FileStreamPosition mode = FileStreamPosition.Current);

    #region StreamProcedure
    [LibraryImport(DllName)]
    internal static partial int BASS_StreamCreate(int frequency, int channels, BassFlags flags, StreamProcedure procedure, IntPtr user);
    ...
    #region Dummy/Push
    [LibraryImport(DllName)]
    internal static partial int BASS_StreamCreate(int frequency, int channels, BassFlags flags, IntPtr procedureType, IntPtr user = default(IntPtr));
    ...
    /// <exception cref="Errors.Memory">There is insufficient memory.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_StreamPutData")]
    public static partial int StreamPutData(int handle, IntPtr buffer, int length);
    ...
    /// <exception cref="Errors.Memory">There is insufficient memory.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_StreamPutData")]
    public static partial int StreamPutData(int handle, byte[] buffer, int length);
    ...
    /// <exception cref="Errors.Memory">There is insufficient memory.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_StreamPutData")]
    public static partial int StreamPutData(int handle, short[] buffer, int length);
    ...
    /// <exception cref="Errors.Memory">There is insufficient memory.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_StreamPutData")]
    public static partial int StreamPutData(int handle, int[] buffer, int length);
    ...
    /// <exception cref="Errors.Memory">There is insufficient memory.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_StreamPutData")]
    public static partial int StreamPutData(int handle, float[] buffer, int length);
    #endregion
    ...
    /// <exception cref="Errors.Ended">The stream has ended.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_StreamPutFileData")]
    public static partial int StreamPutFileData(int handle, IntPtr buffer, int length);
    ...
    /// <exception cref="Errors.Ended">The stream has ended.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_StreamPutFileData")]
    public static partial int StreamPutFileData(int handle, byte[] buffer, int length);
    ...
    /// <exception cref="Errors.Ended">The stream has ended.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_StreamPutFileData")]
    public static partial int StreamPutFileData(int handle, short[] buffer, int length);
    ...
    /// <exception cref="Errors.Ended">The stream has ended.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_StreamPutFileData")]
    public static partial int StreamPutFileData(int handle, int[] buffer, int length);
    ...
    /// <exception cref="Errors.Ended">The stream has ended.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_StreamPutFileData")]
    public static partial int StreamPutFileData(int handle, float[] buffer, int length);
    #endregion
    ...
    [LibraryImport(DllName, EntryPoint = "BASS_StreamFree")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool StreamFree(int handle);
}