...
public static partial class Bass
{
    ...
    [LibraryImport(DllName, EntryPoint = "BASS_RecordInit")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool RecordInit(int device = DefaultDevice);
    ...
    [LibraryImport(DllName, EntryPoint = "BASS_RecordFree")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool RecordFree();

    #region RecordStart
    [LibraryImport(DllName)]
    internal static partial int BASS_RecordStart(int freq, int chans, BassFlags flags, RecordProcedure proc, IntPtr user);
    ...
    [LibraryImport(DllName)]
    internal static partial int BASS_RecordGetDevice();

    [LibraryImport(DllName)]
    [return: MarshalAs(UnmanagedType.Bool)]
    internal static partial bool BASS_RecordSetDevice(int device);
    ...
    /// <exception cref="Errors.DirectX">A sufficient version of DirectX is not installed.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_RecordGetDeviceInfo")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool RecordGetDeviceInfo(int device, out DeviceInfo info);
    ...
    /// </returns>
    /// <exception cref="Errors.Init"><see cref="RecordInit" /> has not been successfully called - there are no initialized devices.</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_RecordGetInfo")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool RecordGetInfo(out RecordInfo info);
    ...
    /// <exception cref="Errors.Unknown">Some other mystery problem!</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_RecordGetInput")]
    public static partial int RecordGetInput(int input, out float volume);

    [LibraryImport(DllName)]
    internal static partial int BASS_RecordGetInput(int input, IntPtr volume);
    ...
    [LibraryImport(DllName)]
    internal static partial IntPtr BASS_RecordGetInputName(int input);
    ...
    /// <exception cref="Errors.Unknown">Some other mystery problem!</exception>
    [LibraryImport(DllName, EntryPoint = "BASS_RecordSetInput")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool RecordSetInput(int input, InputFlags setting, float volume);
}