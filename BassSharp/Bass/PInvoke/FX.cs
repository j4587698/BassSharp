...
public static partial class Bass
{
    ...
    [LibraryImport(DllName, EntryPoint = "BASS_FXSetParameters")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool FXSetParameters(int handle, IntPtr parameters);
    ...
    [LibraryImport(DllName, EntryPoint = "BASS_FXGetParameters")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool FXGetParameters(int handle, IntPtr parameters);
    ...
    /// </remarks>
    [LibraryImport(DllName, EntryPoint = "BASS_FXReset")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool FXReset(int handle);
    ...
    [LibraryImport(DllName, EntryPoint = "BASS_ChannelSetFX")]
    public static partial int ChannelSetFX(int handle, EffectType type, int priority);
    ...
    /// </remarks>
    /// <seealso cref="ChannelSetFX"/>
    [LibraryImport(DllName, EntryPoint = "BASS_ChannelRemoveFX")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool ChannelRemoveFX(int handle, int fx);
    ...
    [LibraryImport(DllName, EntryPoint = "BASS_FXSetPriority")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial bool FXSetPriority(int handle, int priority);
}