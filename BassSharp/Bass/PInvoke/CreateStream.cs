...
public static partial class Bass
{
    ...
    internal static partial int BASS_StreamCreateFile([MarshalAs(UnmanagedType.Bool)]bool mem, string file, long offset, long length, BassFlags flags);

    [LibraryImport(DllName)]
    internal static partial int BASS_StreamCreateFile([MarshalAs(UnmanagedType.Bool)]bool mem, IntPtr file, long offset, long length, BassFlags flags);
    ...
    [LibraryImport(DllName)]
    internal static partial int BASS_StreamCreateFileUser(StreamSystem system, BassFlags flags, ref FileProceduresIntPtr procs, IntPtr user);
    ...
    {
        var procs = new FileProceduresIntPtr(procedures);
        var h = BASS_StreamCreateFileUser(system, flags, ref procs, user);
    ...
    [LibraryImport(DllName, StringMarshalling = StringMarshalling.Utf16)]
    internal static partial int BASS_StreamCreateURL(string url, int offset, BassFlags flags, DownloadProcedure procedure, IntPtr user);
